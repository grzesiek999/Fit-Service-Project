...
from .views import RegisterView, LoginView, UserView, LogoutView, ConfirmAccountView, SendEmailAgainView, SendPasswordRestoreView, SetNewPasswordView, GetByUserIdView
...
urlpatterns = [
    ...
    path('getby_userid', GetByUserIdView.as_view()),
]
